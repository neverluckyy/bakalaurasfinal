...
export function validatePassword(password) {
  ...
  if (score < 50) {
    warnings.push('Consider using a longer password or adding more character variety for better security.');
  }
  
  // Check for missing character types (warnings, not errors)
